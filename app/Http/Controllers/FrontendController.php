...
class FrontendController extends Controller
{
    ...
    {
        return view('frontend.pages.loginOTP');
    }
    ...
    public function registerSubmit(Request $request)
    {
        ...
        \Mail::to($data['email'])->send(new OTPLogin);
        Session::put('user', $data['email']);
        if ($check) {
