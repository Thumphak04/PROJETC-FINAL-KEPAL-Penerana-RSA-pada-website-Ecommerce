...
@section('title','SABA-Store || Halaman Utama')
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                ...
                                                <div class="product-action-2">
                                                    <a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Tambah Ke cart</a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a href="{{route('add-to-cart',$product->slug)}}">Tambah Ke cart</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <form action="{{route('single-add-to-cart')}}" method="POST" class="mt-4">
                                            ...
                                            <div class="add-to-cart">
                                                <button type="submit" class="btn">Tambah Ke cart</button>
