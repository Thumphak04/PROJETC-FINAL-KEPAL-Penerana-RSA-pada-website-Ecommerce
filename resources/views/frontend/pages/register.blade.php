...
@section('title','SABA-Store || Halaman Pendaftaran')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Registrasi</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2>Registrasi</h2>
                        <p>Silahkan isi form  Pendaftaran Jika Anda ingin Berbelanja di SABA-Store</p>
                        <!-- Form -->
