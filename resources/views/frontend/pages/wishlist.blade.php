					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">TAMBAH KECART</th> 
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Tambah Ke Cart</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Tidak Ada Produk Wislisht . <a href="{{route('product-grids')}}" style="color:blue;">Lanjut Berbelanja</a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<i class="ti-lock"></i>
						<h4>Kemanan Pembayaran</h4>
						<p>100% Amana dan Terjamin</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-ratting-review">
                                        ...
                                        <div class="quickview-stock">
                                            <span><i class="fa fa-check-circle-o"></i>Stok Tersedia</span>
                                        </div>
                                    </div>
                                    <h3>Rp.329.0000</h3>
									...
									<div class="size">
										<div class="row">
											...
											<div class="col-lg-6 col-12">
												<h5 class="title"> Pilihan Warna</h5>
												<select>
									...
									<div class="add-to-cart">
										<a href="#" class="btn">Tamba Ke Cart</a>
