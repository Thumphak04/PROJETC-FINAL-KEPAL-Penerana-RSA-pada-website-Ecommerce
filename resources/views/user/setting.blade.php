...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Deskripsi Lengkap <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Gambar/Foto <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">Nomor Handphone <span class="text-danger">*</span></label>
